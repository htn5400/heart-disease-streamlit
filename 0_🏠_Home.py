...
st.set_page_config(page_title="Heart Disease", page_icon="🫀", layout='wide')

# Setting Markdown Style to Increase Font Size
st.markdown("""
<style>
.big-font {
...
st.sidebar.info(
    ...
    \n
    [GitHub Respository](https://github.com/inspiritai-tech/demo-heart-disease)
    """
)
...
# Title
st.title("AI Powered Early Detection for Heart Disease")
st.subheader("Risk Assessment Tool for Patients")

# Hero Image
st.image("hero-image.jpg")
st.caption("Photo Credit: [Towfiqu barbhuiya](https://unsplash.com/@towfiqu999999?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText) on [Unsplash](https://unsplash.com/photos/QsBfOwMoPNY). ")
